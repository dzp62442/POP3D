...
feature_dim = 512  # 768
hidden_dims_ft = 1024
out_dims_ft = hidden_dims_ft

# number of layers of the decoders
dec_layers_occupancy = 2
dec_layers_features = 2
...
model = dict(
    ...
    tpv_aggregator=dict(
        ...
        dec_layers_occupancy=dec_layers_occupancy,
        dec_layers_features=dec_layers_features
    ),
    img_backbone=dict(
        type='ResNet',
        depth=101,
